...
import type { KnowledgeTab, ProjectDocument, ProjectSettings } from "../types";
          ...
          <div className="flex flex-col gap-[14px] p-[18px]">
            ...
            >
              ...
              <strong className="block text-neon-text mt-3 mb-[6px]">
                {props.selectedFileName || "Drop files or click to upload"}
              </strong>
            ...
            {/* URL form */}
            <form className="flex flex-col gap-3" onSubmit={props.onAddUrl}>
          ...
          <div className="flex flex-col gap-[14px] p-[18px]">
                ...
                {(
                  ...
                  >
                    <input
                      ...
                      onChange={() =>
                        props.setSettingsDraft({ ...draft, retrievalStrategy: option.value })
                      }
            ...
            <div className="flex flex-col gap-[14px]">
              <SliderField
                ...
                min={1}
                max={20}
                onChange={(v) => props.setSettingsDraft({ ...draft, chunksPerSearch: v })}
              />
              <SliderField
                ...
                min={1}
                max={20}
                onChange={(v) => props.setSettingsDraft({ ...draft, finalContextSize: v })}
              />
              <SliderField
                ...
                max={1}
                step={0.1}
                onChange={(v) => props.setSettingsDraft({ ...draft, similarityThreshold: v })}
              />
              <SliderField
                ...
                min={0}
                max={8}
                onChange={(v) => props.setSettingsDraft({ ...draft, queryVariationCount: v })}
              />
            </div>
            ...
            >
              <Icon name="settings" />
              <span>{props.isSavingSettings ? "Saving..." : "Apply Settings"}</span>
            </button>
          </div>
        ) : (
          <div className="min-h-[220px] grid place-items-center text-center gap-3 p-7">
